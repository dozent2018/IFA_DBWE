""" wordcount2.py zählt die Geamtzahl der Wörter, die in einem Text vorkommen und
die Anzahl der verschiedenen Wörter. Dabei werden Zeichen wie Satzzeichen, Klammern, 
...
for line in lines :
    ...
    count += len(words)
    # Neue Wörter zur Menge hinzufügen. Kleinschreibung erzwingen
    for word in words :

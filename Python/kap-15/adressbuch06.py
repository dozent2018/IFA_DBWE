"""adressbuch06.py -  Die Adressen werden bei Start aus einer CSV-Datei importiert
und beim Beenden wieder in dieser Datei gespeichert"""
...
# Das Hauptprogramm
# Optionale Auswahl einer CSV-Datei mit Adressen
adressen = dict()
